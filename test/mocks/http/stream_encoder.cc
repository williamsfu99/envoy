...
MockRequestEncoder::MockRequestEncoder() {
  ...
  ON_CALL(*this, encodeHeaders(_, _, _))
      .WillByDefault(Invoke(
          [](const RequestHeaderMap& headers, bool, HeaderKeyFormatterOptConstRef) -> Status {
...
MockResponseEncoder::MockResponseEncoder() {
  ...
  ON_CALL(*this, encodeHeaders(_, _, _))
      .WillByDefault(
          Invoke([](const ResponseHeaderMap& headers, bool, HeaderKeyFormatterOptConstRef) {
